...
class UsuariosModel extends Query
{
    ...
    {
        $sql = "SELECT u.id, u.usuario, u.clave, u.correo, u.id_rol, u.estado, r.rol, r.permisos FROM _usuarios u INNER JOIN roles r ON u.id_rol = r.id WHERE u.usuario = '$usuario' AND u.clave = '$clave'";
    ...
    {
        $sql = "SELECT u.id, u.usuario, u.clave, u.correo, u.id_rol, r.rol, r.permisos
                FROM _usuarios u 
                INNER JOIN roles r ON u.id_rol = r.id 
