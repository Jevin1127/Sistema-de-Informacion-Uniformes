<?php
// Incluye el archivo de helpers.php
...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fas fa-user fa-fw"></i><span class="hidden-xs">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <a class="dropdown-item dropdown-toggle" href="#" id="ayudaDropdown">Ayuda</a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="ayudaDropdown">
                            <?php if (verificar('Manual de usuario')) { ?>
                                <li><a class="dropdown-item" href="https://drive.google.com/file/d/1bRBSIn1DKmRQky9yS0cd2_txsu-QvjAF/view?usp=sharing">Manual de Usuario</a></li>
                            <?php } ?>

                            <?php if (verificar('Manual tecnico')) { ?>
                                <li><a class="dropdown-item" href="https://drive.google.com/file/d/13wE5JM3JmeDj4s4SoEK1QMhSl6v6DThV/view?usp=sharing">Manual Técnico</a></li>
                            <?php } ?>
                        </ul>
                    </li>
                    <li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const ayudaDropdown = document.querySelector('.dropdown-submenu > a');

            ayudaDropdown.addEventListener('click', function(event) {
            ...
            document.addEventListener('click', function(event) {
                const openSubmenu = document.querySelector('.dropdown-submenu .dropdown-menu.show');
                if (openSubmenu && !event.target.closest('.dropdown-submenu')) {
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        &#160;
                        <?php if (verificar('Nueva Venta') || verificar('Historial de Ventas') || verificar('Clientes') || verificar('Tallas')) { ?>
                        ...
                        <?php if (verificar('Nueva Compra') || verificar('Realizadas') || verificar('Proveedores') || verificar('Materia Prima')) { ?>
                            ...
                            <div class="collapse" id="collapseCompras" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <?php if (verificar('Materia Prima')) { ?>
                        ...
                        <?php if (verificar('Productos') || verificar('Catalogo') || verificar('No Reclamados')) { ?>
                            ...
                            <div class="collapse" id="collapseProductos" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <?php if (verificar('Catalogo')) { ?>
                                        <a class="nav-link" href="<?php echo base_url; ?>Catalogo"><i class="fa-solid fa-book-open-reader"></i>
                                            &nbsp;Catalogo</a>
                                    <?php } ?>

                                    <?php if (verificar('No Reclamados')) { ?>
                                        <a class="nav-link" href="<?php echo base_url; ?>NoReclamados"><i class="fa-solid fa-right-left"></i>
                                            &nbsp;No Reclamados</a>
                                    <?php } ?>
                                </nav>
                            </div>
                        ...
                        <?php if (verificar('Produccion') || verificar('Entregas')) { ?>
                        ...
                        <p></p>
                        <?php if (verificar('Usuarios') || verificar('Roles') || verificar('Configuracion') || verificar('Logs de Acceso') || verificar('Respaldo')) { ?>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <?php if (verificar('Logs de Acceso')) { ?>
                                        <a class="nav-link" href="<?php echo base_url; ?>Administracion/logs"><i class="fa-solid fa-user-clock"></i>&nbsp;Logs de Acceso</a>
                                    <?php } ?>
                                    <?php if (verificar('Respaldo')) { ?>
                                        <a class="nav-link" href="<?php echo base_url; ?>Respaldo"><i class="fa-solid fa-file-import"></i>&nbsp;Respaldo</a>
                                    <?php } ?>
                                </nav>
                            </div>
                        <?php } ?>
